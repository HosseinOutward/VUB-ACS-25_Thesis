...
class ResNet20(nn.Module):
    ...
    def _make_layer(self, in_channels, out_channels, blocks, stride=1):
        ...
        layers.append(BasicBlockCIFAR(in_channels, out_channels, stride))

        # Remaining blocks
        for _ in range(1, blocks):
            layers.append(BasicBlockCIFAR(out_channels, out_channels, 1))
...
class BasicBlockCIFAR(nn.Module):
    """Basic block for ResNet20 optimized for CIFAR-10"""
